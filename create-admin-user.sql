...
-- 2. Criar o usuário na tabela auth.users usando a extensão pgcrypto
-- Nota: auth.users não tem constraint UNIQUE no email, então vamos usar uma abordagem diferente
DO $$
DECLARE
    admin_user_id UUID;
BEGIN
